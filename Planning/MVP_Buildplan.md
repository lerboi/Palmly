...
| **Next task** | **P3.T2** — migration 0001 (schema §3.2) + 0002 (RLS §3.3) + RLS test suite (the deliverable) |
...
| **Last completed task** | P3.T1 (Docker-free backend harness — `node --test` 3/3 vs staging) |
