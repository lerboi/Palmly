...
| **Next task** | **P3.T3** — storage buckets (private `scans`, public `cards`) + `storage.objects` RLS (path-owner) + signed-upload helper |
...
| **Last completed task** | P3.T2 (schema + RLS + 19/19 RLS proofs; adversarial-reviewed) |
