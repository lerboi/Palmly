...
- **Baseline suites (re-pinned 2026-07-17; both grow as tasks add regression tests — Node B0 100 → B1 105 → B2 106 → B3 109 → B4 111 → B5 112 → B6 113 → B7 114 → B10 117; Deno 133 → B4 137 → B6 138 → B8 140 → B10 141):**
  **Node 117/117** (`# pass 117 / # fail 0`, 267.8s) · **Deno 141/141** (`141 passed | 0 failed`, 3s)
...
- **Last completed:** **B10** (2026-07-17) — migration 0024 applied; H5 ordering (+ the `seq` column
  the literal fix needed) and M12b citations. Suites: **Node 117/117**, **Deno 141/141**.
- **Next task:** **B11 — Compat surface: free-tier gate atomicity + display_name injection** *(M8, M9)*.
  Note: chat deflection regexes being English-only is **acceptable for an EN launch** (the audit
  agrees) — record it, don't fix it.
