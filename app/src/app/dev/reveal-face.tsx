...
import { PREVIEW_GEOMETRY, PREVIEW_FACE_READING } from '@/features/reading/reveal';
...
export default function RevealFacePreview() {
  return <RevealView reading={PREVIEW_FACE_READING} geometry={PREVIEW_GEOMETRY} kind="face" state="ready" />;
}
